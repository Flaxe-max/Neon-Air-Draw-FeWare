  ...
  return (
    <div style={{
          ...
          >
            ...
            <div>
              <div style={{
                ...
                <Palette size={16} /> {t.colorPalette}
              </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: 'rgba(255, 255, 255, 0.5)', marginBottom: '8px' }}>
                  {t.brushThickness}: {settings.lineWidth}px
                </label>
                <input
                  type="range"
                  min="1"
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
              <ActionButton icon={<Undo2 size={18} />} label={t.undo} onClick={onUndo} />
              <ActionButton icon={<Redo2 size={18} />} label={t.redo} onClick={onRedo} />
              <ActionButton icon={<Trash2 size={18} />} label={t.clear} onClick={onClear} />
              <ActionButton icon={<Download size={18} />} label={t.save} onClick={onSave} />
              <ActionButton
                icon={cameraVisible ? <EyeOff size={18} /> : <Eye size={18} />}
                label={cameraVisible ? t.hideCam : t.showCam}
                onClick={onToggleCamera}
              />
              <ActionButton
                icon={<Zap size={18} />}
                label={gestureVisible ? t.gesturesOn : t.gesturesOff}
      ...
      <div style={{
        ...
        <a
          href="https://www.instagram.com/flaxemax"
          target="_blank"
        ...
        <a
          href="https://github.com/Flaxe-max"
          target="_blank"
          rel="noopener noreferrer"
          style={{
            color: 'rgba(255, 255, 255, 0.6)',
